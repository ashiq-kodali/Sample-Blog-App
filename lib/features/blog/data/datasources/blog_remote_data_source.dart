...
abstract interface class BlogRemoteDataSource{
  ...
  Future<String> uploadBloagImage({required File image ,required BlogModel blog});
}
...
class BlogRemoteDataSourceImpl implements BlogRemoteDataSource{
  ...
  @override
  Future<String> uploadBloagImage({required File image, required BlogModel blog}) async{
    try{
